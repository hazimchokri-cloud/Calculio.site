          ...
          {offers.slice(0, 2).map(offer => {
            ...
            return (
              ...
              >
                ...
                {offer.ctaUrl && offer.ctaUrl.startsWith('http') && !offer.ctaUrl.includes('google.com') && offer.ctaUrl !== '#' ? (
                  <a
                    href={offer.ctaUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full py-1.5 px-2.5 rounded-lg bg-[#F97316] hover:bg-[#EA580C] text-white text-[11px] font-bold transition-all flex items-center justify-center gap-1 shadow-2xs cursor-pointer no-underline"
                  >
                  ...
                  <button
                    type="button"
                    disabled
                    className="w-full py-1.5 px-2.5 rounded-lg bg-[#F1F5F9] text-[#94A3B8] text-[11px] font-bold flex items-center justify-center gap-1 cursor-not-allowed border border-[#E2E8F0]"
                  >
                    <span>{offer.ctaText}</span>
                  </button>
                )}
              ...
              <div className="pt-5 mt-4 border-t border-[#E2E8F0] space-y-2">
                {offer.ctaUrl && offer.ctaUrl.startsWith('http') && !offer.ctaUrl.includes('google.com') && offer.ctaUrl !== '#' ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full py-2.5 px-4 bg-[#F97316] hover:bg-[#EA580C] text-white text-xs sm:text-sm font-bold rounded-xl transition-all shadow-xs flex items-center justify-center gap-2 active:scale-98 cursor-pointer no-underline"
                  >
                    <span>{offer.ctaText}</span>
                  ...
                  <button
                    type="button"
                    disabled
                    className="w-full py-2.5 px-4 bg-[#F1F5F9] text-[#94A3B8] text-xs sm:text-sm font-bold rounded-xl flex items-center justify-center gap-2 cursor-not-allowed border border-[#E2E8F0]"
                  >
                    <span>{offer.ctaText}</span>
                  </button>
                )}
