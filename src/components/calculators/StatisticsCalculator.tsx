        ...
        <div className="lg:col-span-6 space-y-5">
          {stats ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center space-y-2">
              <p className="text-orange-600 font-semibold text-sm">Please enter a dataset.</p>
              <p className="text-xs text-slate-500">Enter comma or space separated numbers above to calculate statistics.</p>
            </div>
          )}
        </div>
      </div>
